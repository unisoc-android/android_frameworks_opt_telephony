...
public class IccProviderExImpl extends AbsIccProvider {
    ...
    private void throwException(int errorCode) {
        switch (errorCode) {
            ...
            case IccPhoneBookOperationException.OVER_ANR_MAX_LENGTH:
                throw new IccPBForMimetypeException(
                        IccPBForMimetypeException.OVER_ANR_LENGTH_LIMIT,
                        Phone.CONTENT_ITEM_TYPE, "over the length of anr phone number");
            default:
                break;
        }
    }
