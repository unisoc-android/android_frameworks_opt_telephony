    ...
    public void handleMessage(Message msg) {
        ...
        try {
            ...
            case EVENT_READ_RECORD_DONE:
                ...
                if (ar.exception != null) {
                    logd("ar.exception=" + ar.exception);
                    sendResult(response, null, ar.exception);
                    break;
                }
                /**
                 * UNISOC: modify for bug1031743 When iccException is not null, return the result that was previously read * @{
                 */
                iccException = result.getException();
                if (iccException != null) {
                    logd("iccException=" + iccException);
                    if (lc.mLoadAll && lc.results != null && lc.results.size() > 0) {
